            ...
            <article>
                ...
                <div class="content-account <?php echo $none_address ?>">
                    ...
                    <div class="information-account">
                        ...
                        <div class="row-account">
                            <a href="../../controller/index.php?url=edit-my-account">Chỉnh sửa thông tin</a>
                        </div>
                    </div>
                </div>
                <div class="account <?php echo $block_form_address ?>">
                    <form class="form-content-pay form-account" action="../../model/user/handle-add-address.php" method="POST">
                        ...
                        <div class="left-content-pay content-account">
                            ...
                            <div class="address">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ward" class="ward">
                                    <small class="error"></small>
                                </div>
                                <div class="form-group">
                                    <label for="">Địa chỉ <span>*</span></label>
                                    <input type="text" placeholder="Địa chỉ chi tiết" name="address-detail" class="address-detail">
                                    <small class="error"></small>
                                </div>
                                <div class="form-group">
